...
<div id="box">
	<div id="main">
		...
		<div class="content">
			...
			<div class="item" data-t="<?php echo ($vo["name"]); ?>" data-url='<?php echo U("Index/exchangeDetail",array("k"=>$vo["goods_id"]),false,false,true);?>'>
				...
				<div class="info">
					...
					<div><?php echo formartDate($vo['lottery']['start_time'],'Y-m-d H:i');?> 总共<?php echo ($vo["total_num"]); ?>件，等你来兑</div>
				</div>
				<div class="bar">
